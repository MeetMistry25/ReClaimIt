...
const ReportLostItem = () => {
  ...
  const [form, setForm] = useState({
    ...
    itemName: '',
    description: '',
    verificationQuestion: 'What is the color of the item?',
    verificationAnswer: '',
  });
  ...
  const validate = () => {
    ...
    if (!form.verificationAnswer) newErrors.verificationAnswer = 'Required';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append('placeLost', form.location);
      formData.append('dateLost', form.date);
      formData.append('verificationQuestion', form.verificationQuestion);
      formData.append('verificationAnswer', form.verificationAnswer);
  ...
  return (
    <div className="max-w-4xl mx-auto dark:bg-gray-900 dark:text-gray-100">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-primary-100 mb-2">Report Lost Item</h1>
        <p className="text-gray-600 dark:text-gray-300">Report an item you've lost on campus</p>
      </div>
      <div className="card dark:bg-gray-800 dark:border-gray-700">
        {!selectedCategory ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-gray-600 dark:text-gray-300">Redirecting to lost items...</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="form-label">When was it lost?</label>
            ...
            <div>
              <label className="form-label">Where was it lost?</label>
            ...
            <div>
              ...
              <input type="text" name="verificationQuestion" className="input-field dark:bg-gray-900 dark:border-gray-700 dark:text-primary-100" value={form.verificationQuestion} onChange={handleChange} />
              <p className="text-sm text-gray-500 mt-1">This question will be used to verify ownership when someone claims the item</p>
            </div>
            <div>
              <label className="form-label">Verification Answer</label>
              <input type="text" name="verificationAnswer" className="input-field dark:bg-gray-900 dark:border-gray-700 dark:text-primary-100" value={form.verificationAnswer} onChange={handleChange} required />
              {errors.verificationAnswer && <div className="text-red-500 text-sm">{errors.verificationAnswer}</div>}
              <p className="text-sm text-gray-500 mt-1">The answer to the verification question</p>
            </div>
            <div>
